                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {/* Tab Navigation */}
                                <div className="flex gap-1 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-1 border border-gray-200 dark:border-gray-700">
                                    {tabs.map(tab => (
                                        <button
                                            key={tab.key}
                                            id={`tab-${tab.key}-btn`}
